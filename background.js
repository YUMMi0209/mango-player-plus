...
// v2.0：总开关拆分为「日志记录 / 视频控制栏」两个独立开关；lastMode 记忆上次的面板显示模式；annotateTimecode 标注截图嵌入时间码开关；recCodec 录制编码（vp8 / vp9 / h264 / h264-low，默认 vp8；仅 h264-low 固定 720P，其余跟随源分辨率）；noteFileName 备注写入文件名开关
const DEFAULT_SETTINGS = { enabled: true, activeHosts: [], theme: 'dark', logEnabled: true, barEnabled: true, danmuBlock: true, noteFileName: true, pipRecord: false, lastMode: 'sidebar', annotateTimecode: false, recCodec: 'vp8' };
      ...
      await chrome.scripting.registerContentScripts([
        {
          ...
          matches, js: ['content/tc-parse.js', 'content/remux.js', 'content/webm-color.js', 'content/content.js', 'content/control-bar.js'],
